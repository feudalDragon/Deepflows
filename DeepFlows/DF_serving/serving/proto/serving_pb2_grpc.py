...
class MyDLPWServingStub(object):
...
def add_MyDLPWServingServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'MyDLPW.serving.MyDLPWServing', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class MyDLPWServing(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def Predict(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/MyDLPW.serving.MyDLPWServing/Predict',
